...
on extensive configurability, massive extensibility and ease of use.`)
	...
	*/
	...
	flagSet.CreateGroup("output", "Output",
		...
		flagSet.BoolVar(&options.JSON, "json", true, "write output in JSONL(ines) format"),
	...
	flagSet.CreateGroup("optimization", "Optimizations",
		flagSet.IntVar(&options.Timeout, "timeout", 30, "time to wait in seconds before timeout"),
